    ...
    public void onClick(View v) {
        ...
        if (id == R.id.openLog) {
            ...
            ARouter.getInstance().build("/kotlin/test")
                    ...
                    .withInt("age", 23)
                    .navigation();
        } else if (id == R.id.normalNavigationWithParams) {
            ...
            ARouter.getInstance().build("/xxx/xxx").navigation(this, new NavCallback() {
                @Override public void onFound(Postcard postcard) { Log.d("ARouter", "找到了"); }
                @Override public void onLost(Postcard postcard) { Log.d("ARouter", "找不到了"); }
                @Override public void onArrival(Postcard postcard) { Log.d("ARouter", "跳转完了"); }
